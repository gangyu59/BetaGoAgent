...
class BetaGoNet(nn.Module):
    def __init__(self, board_size=9, num_res_blocks=4, num_channels=64, input_planes=7):
        super().__init__()
    ...
    def forward(self, x):
        # x: (batch, input_planes, board_size, board_size)
        ...
        v = torch.tanh(self.value_fc2(v)) # Output [-1, 1]
